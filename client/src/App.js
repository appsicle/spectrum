    ...
    <div className="App">
      <Router>
        <Switch>
          ...
          <Route exact path="/room/:roomId" component={() => <Room socket={socket} startGame={startGame} user={user} roomId={roomId} roomData={roomData} updateUserPosition={updateUserPosition} setUser={setUser}/>} />
        </Switch>
      </Router>
    </div>
  );
